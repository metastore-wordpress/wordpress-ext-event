...
/**
 * Class WP_EXT_Event_Taxonomy
 * ------------------------------------------------------------------------------------------------------------------ */

class WP_EXT_Event_Taxonomy extends WP_EXT_Event {
	...
	public function taxonomy_meta() {
		$labels  = [
			'name'                       => _x( 'Event Meta', 'Meta General Name', 'wp-ext-' . $this->domain_ID ),
 ...
 *
 * @return WP_EXT_Event_Taxonomy
 * ------------------------------------------------------------------------------------------------------------------ */

function WP_EXT_Event_Taxonomy() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Event_Taxonomy;
	}
...
add_action( 'plugins_loaded', [ WP_EXT_Event_Taxonomy(), 'run' ] );
