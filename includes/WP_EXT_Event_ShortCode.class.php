...
/**
 * Class WP_EXT_Event_ShortCode
 * ------------------------------------------------------------------------------------------------------------------ */

class WP_EXT_Event_ShortCode extends WP_EXT_Event {
 ...
 *
 * @return WP_EXT_Event_ShortCode
 * ------------------------------------------------------------------------------------------------------------------ */

function WP_EXT_Event_ShortCode() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Event_ShortCode;
	}
...
add_action( 'plugins_loaded', [ WP_EXT_Event_ShortCode(), 'run' ] );
