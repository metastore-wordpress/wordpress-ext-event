...
/**
 * Class WP_EXT_Event_Template
 * ------------------------------------------------------------------------------------------------------------------ */

class WP_EXT_Event_Template extends WP_EXT_Event {
 ...
 *
 * @return WP_EXT_Event_Template
 * ------------------------------------------------------------------------------------------------------------------ */

function WP_EXT_Event_Template() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Event_Template;
	}
...
add_action( 'plugins_loaded', [ WP_EXT_Event_Template(), 'run' ] );
