...
/**
 * Class WP_EXT_Event_Post_Type
 * ------------------------------------------------------------------------------------------------------------------ */

class WP_EXT_Event_Post_Type extends WP_EXT_Event {
	...
	public function post_type() {
		$labels       = [
			'name'                  => _x( 'Events', 'Event General Name', 'wp-ext-' . $this->domain_ID ),
			'singular_name'         => _x( 'Event', 'Event Singular Name', 'wp-ext-' . $this->domain_ID ),
			'menu_name'             => __( 'Events', 'wp-ext-' . $this->domain_ID ),
			'name_admin_bar'        => __( 'Event', 'wp-ext-' . $this->domain_ID ),
		...
		$args         = [
			'label'               => __( 'Event', 'wp-ext-' . $this->domain_ID ),
			'description'         => __( 'Event Description', 'wp-ext-' . $this->domain_ID ),
			'labels'              => $labels,
 ...
 *
 * @return WP_EXT_Event_Post_Type
 * ------------------------------------------------------------------------------------------------------------------ */

function WP_EXT_Event_Post_Type() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Event_Post_Type;
	}
...
add_action( 'plugins_loaded', [ WP_EXT_Event_Post_Type(), 'run' ] );
